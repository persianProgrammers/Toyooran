    ...
    <div className="min-h-screen relative overflow-hidden z-0" id="about-page">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24 relative z-10 space-y-16">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white/60 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 border border-white shadow-xl shadow-slate-300/40"
        >
        ...
        <motion.div 
          ...
          className="bg-white/60 backdrop-blur-md rounded-[2.5rem] p-8 sm:p-12 border border-white shadow-xl shadow-slate-300/40"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS_AND_PROOF.map((item, i) => (
              <div key={i} className="bg-white/70 backdrop-blur-md p-8 rounded-[2rem] border border-white shadow-lg shadow-slate-200/50 hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
