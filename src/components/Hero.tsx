    ...
    >
      ...
      <div className="absolute inset-[2px] rounded-[calc(2.5rem-2px)] bg-[#001c3d] z-10 overflow-hidden flex flex-col p-6 sm:p-8">
        ...
        <div className="relative z-20 flex justify-end w-full">
          <span className="inline-block px-3 py-1.5 rounded-full bg-white/5 border border-white/30 text-[10px] sm:text-xs font-bold text-slate-300 group-hover:border-amber-400/40 group-hover:text-amber-300 group-hover:bg-amber-400/10 transition-all duration-500  transform-gpu will-change-transform shadow-lg">
            {card.badge}
          </span>
        </div>
