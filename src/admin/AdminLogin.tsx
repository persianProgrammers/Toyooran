...
export const AdminLogin: React.FC<AdminLoginProps> = ({ onBackToSite }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#00224B] to-slate-950 text-slate-100 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-['Vazirmatn',sans-serif]" dir="rtl">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#003F86] border-2 border-amber-400/80 shadow-xl mb-4 relative group">
            <div className="w-8 h-8 border-2 border-amber-400 rounded-sm transform rotate-45 flex items-center justify-center bg-[#003F86]">
        ...
        <div className="bg-slate-900/90 backdrop-blur-xl border border-slate-700/70 rounded-3xl p-6 sm:p-8 shadow-2xl relative">
          ...
          {error && (
            <div className="mb-5 bg-rose-500/10 border border-rose-500/30 text-rose-300 p-3.5 rounded-2xl text-xs flex items-start gap-2.5">
