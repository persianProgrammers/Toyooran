      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-slate-200 relative">
        ...
        <div className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-slate-200 p-4 sm:p-6 flex items-center justify-between z-20">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs font-black bg-amber-400 text-slate-950 px-2.5 py-0.5 rounded-md">
              {product.code}
            </span>
          </div>
          <button
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-3">
              <div className="rounded-2xl overflow-hidden bg-slate-100 border border-slate-200 h-64 sm:h-72 shadow-sm">
                <img
                  src={product.image}
                  alt={product.name}
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-normal bg-slate-50 p-4 rounded-2xl border border-slate-100">
