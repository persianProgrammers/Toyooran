...
for filename in ["src/components/AboutContactUnifiedSection.tsx", "src/components/ContactPage.tsx"]:
    ...
    # Find the entire map background block
    start_str = '{/* Map Background */}'
    
    # We will search for the first occurrence of className="absolute inset-0 z-0 bg-[#002d61]"
    # and replace everything up to the Left Edge Glow
