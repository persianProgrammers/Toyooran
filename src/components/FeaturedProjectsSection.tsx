        ...
        <motion.div  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {displayedProjects.map((project, index) => (
              <motion.div
                ...
                key={project.id}
                className="relative bg-white/95 backdrop-blur-sm transform-gpu will-change-transform rounded-[2rem] border border-white/80 overflow-hidden shadow-lg shadow-slate-200/50 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col group cursor-pointer origin-center"
