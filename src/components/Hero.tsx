    ...
    >
      ...
      <div className="absolute inset-[2px] rounded-[calc(2.5rem-2px)] bg-[#001c3d] z-10 overflow-hidden flex flex-col p-6 sm:p-8">
        ...
        <div className="relative z-20 flex justify-end w-full">
          <span className="inline-block px-3 py-1.5 rounded-full bg-white/5 border border-white/30 text-[10px] sm:text-xs font-bold text-slate-300 group-hover:border-amber-400/40 group-hover:text-amber-300 group-hover:bg-amber-400/10 transition-all duration-500 backdrop-blur-sm transform-gpu will-change-transform shadow-lg">
            {card.badge}
          </span>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-20 transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:-translate-y-4">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 flex items-center justify-center">
              ...
              {(() => {
                switch(card.id) {
                  case 'heating': return (
                    <div className="relative w-12 h-12 sm:w-14 sm:h-14 rotate-45 border-[1px] border-blue-400/60 bg-gradient-to-br from-blue-400/30 to-transparent backdrop-blur-sm transform-gpu will-change-transform group-hover:border-blue-400/100 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.4),inset_0_0_15px_rgba(59,130,246,0.2)] transition-all duration-700 group-hover:rotate-[135deg] flex items-center justify-center">
                  ...
                  case 'cooling': return (
                    <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl border-[1px] border-emerald-400/60 bg-gradient-to-br from-emerald-400/30 to-transparent backdrop-blur-sm transform-gpu will-change-transform group-hover:border-emerald-400/100 group-hover:shadow-[0_0_20px_rgba(16,185,129,0.4),inset_0_0_15px_rgba(16,185,129,0.2)] transition-all duration-700 group-hover:rotate-[90deg] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-5xl mx-auto w-full mt-[-8vh] sm:mt-[-5vh]">
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm transform-gpu will-change-transform border border-white/30 px-4 py-1.5 rounded-full mb-6"
          >
          ...
          >
            ...
            <Link
              to="/contact"
              className="w-full sm:w-auto bg-slate-900/40 hover:bg-slate-800/60 text-white font-bold px-8 py-3.5 rounded-full text-sm sm:text-base flex items-center justify-center gap-2 border-[1.5px] border-white/40 backdrop-blur-sm transform-gpu will-change-transform shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
            >
                ...
                <div className="mt-8 relative group w-full rounded-[2.5rem] overflow-hidden bg-gradient-to-r from-[#001c3d] via-[#002d61] to-[#003F86] border border-blue-800 p-8 sm:p-10 cursor-pointer shadow-xl hover:shadow-2xl transition-all duration-500" onClick={onOpenConsultation}>
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
                       <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-right gap-6">
                          {/* Glowing Award Badge */}
                          <div className="relative w-20 h-20 shrink-0 rounded-2xl bg-white/10 backdrop-blur-sm transform-gpu will-change-transform border-[1.5px] border-white/40 flex items-center justify-center shadow-[0_0_20px_rgba(0,0,0,0.2)] group-hover:scale-110 transition-transform duration-500 group-hover:rotate-6">
