...
export const ProductsTab: React.FC = () => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    const fullProduct: Product = {
      ...
      image: formData.image || 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=800&q=80',
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-700 rounded-3xl p-6 sm:p-8 max-w-3xl w-full my-8 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              {/* Row 3: Image URL */}
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1">آدرس تصویر محصول (URL)</label>
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="https://..."
                    required
                    className="flex-1 bg-slate-950 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white focus:border-amber-400 font-mono"
                  />
                  {formData.image && (
                    <img
                      src={formData.image}
